      ...
      <main className="relative z-10 mx-auto max-w-6xl px-6 py-12">
        <header className="mb-10">
          ...
          <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Link
              href="/shop/local"
              className="shrink-0 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-xs font-medium text-white/50 transition-colors hover:border-fuchsia-500/30 hover:text-fuchsia-300/90"
            >
              Browse Local Brands →
            </Link>
          </div>
